...
Contributors: cyberlord92, miniOrange
...
Security with firewall, malware scanner, login and spam protection and encrypted backup. WP Security Plugin includes Login Security, Limit login attempts, Spam Protection, Content Protection, Blocking & more to Secure Wordpress
...
<ul>
	<li>Wordpress-Level Web Application Firewall</li>
	<li>Server Level On-premise WAF</li>
	<li>Server Level Cloud-based WAF</li>
</ul>
...
2. Firewall Dashboard
3. Firewall Settings
4. Login Security and Spam Security
5. Malware Scanner
6. Backup
...
= 4.0.7 =
* Malware scanner reload fix and Firewall plus security css issue fixes.

= 4.0.6 =
* Google Recaptcha validation Issues fix.

= 4.0.5 =
* Wordpress Security Readme Issues

= 4.0.4 =
* Security infromation Update
