...
echo'	<div class="mo_wpns_table_layout">
		...
		<h2>Licensing Plans
		<span style="float:right"><input type="button" name="ok_btn" id="ok_btn" class="mo_wpns_button mo_wpns_button1" value="OK, Got It" onclick="window.location.href=\''. $default_url .'\'" /></span>
		</h2><hr>
