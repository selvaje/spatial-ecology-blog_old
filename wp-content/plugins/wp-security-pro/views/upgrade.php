...
echo '<div class="mo_wpns_small_layout" id="mo_waf">
	  ...
	  <meta name="viewport" content="width=device-width, initial-scale=1">
				...
				<a target="_blank" class="mo_wpns_button mo_wpns_button1"  onclick="wpns_upgrade(\'wp_security_waf_plan\')">Upgrade Now</a>
				<a  id="mo_waf_detail" class=" mo_wpns_button mo_wpns_button1 mo_wpns_collapsible" onclick="expand(this,\'mo_waf\')"  data-active="false">Details >></a>
...
echo '			<div class="mo_wpns_small_layout" id="mo_login">
				...
				<a target="_blank" class="mo_wpns_button mo_wpns_button1" onclick="wpns_upgrade(\'wp_security_login_and_spam_plan\')" >Upgrade Now</a>
				<a id="mo_login_detail" class="mo_wpns_button mo_wpns_button1 mo_wpns_collapsible" onclick="expand(this,\'mo_login\')"data-active="false">Details >></a>
...
echo '			<div class="mo_wpns_small_layout" id="mo_scan">
				...
				<a target="_blank" class="mo_wpns_button mo_wpns_button1" onclick="wpns_upgrade(\'wp_security_malware_plan\')" >Upgrade Now</a>
				<a id="mo_scan_detail" class="mo_wpns_button mo_wpns_button1 mo_wpns_collapsible" onclick="expand(this,\'mo_scan\')"data-active="false">Details >></a>
...
echo '			<div class="mo_wpns_small_layout" id="mo_backup">
				...
				<a target="_blank" class="mo_wpns_button mo_wpns_button1" onclick="wpns_upgrade(\'wp_security_backup_plan\')" >Upgrade Now</a>
				<a id="mo_backup_detail" class="mo_wpns_button mo_wpns_button1 mo_wpns_collapsible" onclick="expand(this,\'mo_backup\')"data-active="false">Details >></a>
	...
	echo '<style>
		...
		<div class="mo_wpns_small_layout mo_wpns_all_in_one_layout mo_all_in_one_pricing" id="mo_all_in_one">
				...
				<div id="mo_all_in_one_align_price" class="mo_align_pricing">
                    ...
                    <a target="_blank" class="mo_wpns_button mo_wpns_button1" onclick="wpns_upgrade(\'wp_security_premium_plan\')">Upgrade Now</a>
				<a id="mo_all_in_one_detail" class="mo_wpns_button mo_wpns_button1 mo_wpns_collapsible" onclick="expand(this,\'mo_all_in_one\')"data-active="false">Details >></a>
